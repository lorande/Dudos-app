...
- Quantidade mínima de abertura:
  ...
  - **Durante o Palafico:** **N − 1** (o bico não é apostável no Palafico).
...
Quando qualquer jogador ativo fica com **1 dado** (modo Dados) **ou 1 vida** (modo Vidas), a rodada vira Palafico: o bico não conta como coringa, apenas a face literal vale. Nessa rodada, a aposta de abertura mínima é **N − 1**.
