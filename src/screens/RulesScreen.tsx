...
const SPECIAL = [
  ...
  { title: '🟣 Passo', body: 'Se você tiver todas as faces diferentes (5 dados distintos), pode declarar "Passo": você pula a vez e a aposta atual permanece. O Passo pode ser dudado por outro jogador — se você realmente tiver as faces distintas, quem duvidou perde; senão, você perde. 1× por rodada.' },
