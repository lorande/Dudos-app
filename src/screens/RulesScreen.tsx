...
const SPECIAL = [
  ...
  { title: '🟣 Passo', body: 'A qualquer momento (na sua vez) você pode declarar "Passo" — pula a vez e a aposta atual permanece. É um blefe: você está alegando ter todas as faces diferentes. Outro jogador pode dudar o Passo: se você realmente tiver todas as faces distintas (contando mão + dados na mesa), quem dudou perde a rodada; se tiver faces repetidas, você perde. 1× por rodada.' },
  { title: '🟢 Mesa', body: 'Escolha quantos dados quiser, revele-os na mesa (públicos, continuam contando) e re-sorteie os dados restantes — em seguida faça uma aposta. 1× por rodada. O Passo continua valendo após a Mesa: a contagem de faces distintas passa a considerar os dados na mão E os colocados na mesa.' },
];
